...
public final class IssueCodes {
	...
	/** A out parameter is missed in the protocol declaration.
	 */
	public static final String REQUIRED_OUT_MESSAGE_FOR_PRIVATE_PARAMETER =
			ISSUE_CODE_PREFIX + "required_out_message_for_private_parameter"; //$NON-NLS-1$
	...
	/** Unnecessary modifier for message argument.
	 */
	public static final String UNNECESSARY_ARGUMENT_MODIFIER =
			ISSUE_CODE_PREFIX + "unnecessary_argument_modifier"; //$NON-NLS-1$
