...
package io.sarl.extensions.bspl.lang.bspl.impl;
 ...
 * @since 1.0
 */
public class BsplProtocolPublicParameterImplCustom extends BsplProtocolPublicParameterImpl {
	 ...
	 * @generated
	 */
	protected BsplProtocolPublicParameterImplCustom() {
		super();
		getModifiers().add("public"); //$NON-NLS-1$
	}
