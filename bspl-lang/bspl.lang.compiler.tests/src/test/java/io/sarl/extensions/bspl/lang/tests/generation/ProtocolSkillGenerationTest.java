	...
	public class PublicParameterTest extends AbstractBsplTest {
		...
		public void message1argument1in() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope.scope + #[ \"A1\" ]).isDefined)) {",
					"            val messageInstance = new M",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A1\" ])",
		...
		public void message1argument2in() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope.scope + #[ \"A1\" ]).isDefined) && (new ScopedDataName(scope.scope + #[ \"A2\" ]).isDefined)) {",
					"            val messageInstance = new M",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A1\" ])",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            val inParamId_1 = new ScopedDataName(scope.scope + #[ \"A2\" ])",
		...
		public void message1argument3in() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope.scope + #[ \"A1\" ]).isDefined) && (new ScopedDataName(scope.scope + #[ \"A2\" ]).isDefined) && (new ScopedDataName(scope.scope + #[ \"A3\" ]).isDefined)) {",
					"            val messageInstance = new M",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A1\" ])",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            val inParamId_1 = new ScopedDataName(scope.scope + #[ \"A2\" ])",
					"            messageInstance.A2 = inParamId_1.getKnowledge(typeof(String))",
					"            val inParamId_2 = new ScopedDataName(scope.scope + #[ \"A3\" ])",
		...
		public void message1argument2in1k() throws Exception {
			...
			var expected = multilineString(
					...
					"            val messageInstance = new M",
					"            messageInstance.A1 = scope.scope.get(0) as double // A1",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A2\" ])",
		...
		public void message1argument3in1key() throws Exception {
			...
			var expected = multilineString(
					...
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A2\" ])",
					"            messageInstance.A2 = inParamId.getKnowledge(typeof(String))",
					"            val inParamId_1 = new ScopedDataName(scope.scope + #[ \"A3\" ])",
		...
		public void message1argument1out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if (!(new ScopedDataName(scope.scope + #[ \"A\" ]).isBound)) {",
					"            val messageInstance = new M",
					"            enabledMessages += new ProtocolMessage<M>(spaceInstance, messageInstance, scope.getKnowledge(typeof(UUID)))",
					"          }",
					"        }",
		...
		public void message1argument1in1out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope.scope + #[ \"A1\" ]).isDefined) && !(new ScopedDataName(scope.scope + #[ \"A2\" ]).isBound)) {",
					"            val messageInstance = new M",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A1\" ])",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            enabledMessages += new ProtocolMessage<M>(spaceInstance, messageInstance, scope.getKnowledge(typeof(UUID)))",
		...
		public void message1argument2in1out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope.scope + #[ \"A1\" ]).isDefined) && (new ScopedDataName(scope.scope + #[ \"A2\" ]).isDefined) && !(new ScopedDataName(scope.scope + #[ \"A3\" ]).isBound)) {",
					"            val messageInstance = new M",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A1\" ])",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            val inParamId_1 = new ScopedDataName(scope.scope + #[ \"A2\" ])",
		...
		public void message1argument3in1out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope.scope + #[ \"A1\" ]).isDefined) && (new ScopedDataName(scope.scope + #[ \"A2\" ]).isDefined) && (new ScopedDataName(scope.scope + #[ \"A3\" ]).isDefined) && !(new ScopedDataName(scope.scope + #[ \"A4\" ]).isBound)) {",
					"            val messageInstance = new M",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A1\" ])",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            val inParamId_1 = new ScopedDataName(scope.scope + #[ \"A2\" ])",
		...
		public void message1argument1in1key1out() throws Exception {
			...
			var expected = multilineString(
					...
					"  @SarlAsynchronousExecution",
					"  override sendMMessage(message : ProtocolMessage<M>) {",
					"    val A2Id = new ScopedDataName(message.^event.A1?.toString, \"A2\")",
					"    var A2 : Object",
					"    synchronized (getWorkingMemoryLock) {",
					"      A2 = A2Id.getKnowledge(typeof(Object))",
					"      A2Id.bind",
		...
		public void message1argument2in1k1out() throws Exception {
			...
			var expected = multilineString(
					...
					"  @SarlAsynchronousExecution",
					"  override sendMMessage(message : ProtocolMessage<M>) {",
					"    val A3Id = new ScopedDataName(message.^event.A1?.toString, \"A3\")",
					"    var A3 : Object",
					"    synchronized (getWorkingMemoryLock) {",
					"      A3 = A3Id.getKnowledge(typeof(Object))",
					"      A3Id.bind",
		...
		public void message1argument3in1key1out() throws Exception {
			...
			var expected = multilineString(
					...
					"  @SarlAsynchronousExecution",
					"  override sendMMessage(message : ProtocolMessage<M>) {",
					"    val A4Id = new ScopedDataName(message.^event.A1?.toString, \"A4\")",
					"    var A4 : Object",
					"    synchronized (getWorkingMemoryLock) {",
					"      A4 = A4Id.getKnowledge(typeof(Object))",
					"      A4Id.bind",
		...
		public void message1argument3in2key2out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope.scope + #[ \"A1\" ]).isDefined) && (new ScopedDataName(scope.scope + #[ \"A2\" ]).isDefined) && !(new ScopedDataName(scope.scope + #[ \"A5\" ]).isBound) && (new ScopedDataName(scope.scope + #[ \"A3\" ]).isDefined) && !(new ScopedDataName(scope.scope + #[ \"A4\" ]).isBound)) {",
					"            val messageInstance = new M",
					"            messageInstance.A1 = scope.scope.get(0) as double // A1",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"A2\" ])",
					"            messageInstance.A2 = inParamId.getKnowledge(typeof(String))",
					...
					"  @SarlAsynchronousExecution",
					"  override sendMMessage(message : ProtocolMessage<M>) {",
					"    val A4Id = new ScopedDataName(message.^event.A1?.toString, message.^event.A3?.toString, \"A4\")",
					"    var A4 : Object",
					"    val A5Id = new ScopedDataName(message.^event.A1?.toString, message.^event.A3?.toString, \"A5\")",
					"    var A5 : int",
					"    synchronized (getWorkingMemoryLock) {",
					"      A4 = A4Id.getKnowledge(typeof(Object))",
		...
		public void message1bargument3in2key2out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance_1 !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope_1.scope + #[ \"A1\" ]).isDefined) && (new ScopedDataName(scope_1.scope + #[ \"A2\" ]).isDefined) && !(new ScopedDataName(scope_1.scope + #[ \"A5\" ]).isBound) && (new ScopedDataName(scope_1.scope + #[ \"A3\" ]).isDefined) && !(new ScopedDataName(scope_1.scope + #[ \"A4\" ]).isBound)) {",
					"            val messageInstance_1 = new M",
					"            messageInstance_1.A1 = scope_1.scope.get(0) as double // A1",
					"            val inParamId_1 = new ScopedDataName(scope_1.scope + #[ \"A2\" ])",
	...
	public class NilArgumentTest extends AbstractBsplTest {
		...
		public void outModifier() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if (!(new ScopedDataName(scope.scope + #[ \"P1\" ]).isBound)) {",
					"            val messageInstance = new M",
					"            enabledMessages += new ProtocolMessage<M>(spaceInstance, messageInstance, scope.getKnowledge(typeof(UUID)))",
					"          }",
					"        }",
		...
		public void inModifier() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (getWorkingMemoryLock) {",
					"          if ((new ScopedDataName(scope.scope + #[ \"P1\" ]).isDefined)) {",
					"            val messageInstance = new M",
					"            val inParamId = new ScopedDataName(scope.scope + #[ \"P1\" ])",
