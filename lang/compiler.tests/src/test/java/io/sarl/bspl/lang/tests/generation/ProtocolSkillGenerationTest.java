	...
	public class PublicParameterTest extends AbstractBsplTest {
		...
		public void message1argument1in() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"A1\", scope.keys).isDefined)) {",
					"            val messageInstance = new M",
					"            val inParamId = new KnowledgeID(\"A1\", scope.keys)",
		...
		public void message1argument2in() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"A1\", scope.keys).isDefined) && (new KnowledgeID(\"A2\", scope.keys).isDefined)) {",
					"            val messageInstance = new M",
					"            val inParamId = new KnowledgeID(\"A1\", scope.keys)",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            val inParamId_1 = new KnowledgeID(\"A2\", scope.keys)",
		...
		public void message1argument3in() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"A1\", scope.keys).isDefined) && (new KnowledgeID(\"A2\", scope.keys).isDefined) && (new KnowledgeID(\"A3\", scope.keys).isDefined)) {",
					"            val messageInstance = new M",
					"            val inParamId = new KnowledgeID(\"A1\", scope.keys)",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            val inParamId_1 = new KnowledgeID(\"A2\", scope.keys)",
					"            messageInstance.A2 = inParamId_1.getKnowledge(typeof(String))",
					"            val inParamId_2 = new KnowledgeID(\"A3\", scope.keys)",
		...
		public void message1argument2in1k() throws Exception {
			...
			var expected = multilineString(
					...
					"            val messageInstance = new M",
					"            messageInstance.A1 = scope.keys.get(0) as double // A1",
					"            val inParamId = new KnowledgeID(\"A2\", scope.keys)",
		...
		public void message1argument3in1key() throws Exception {
			...
			var expected = multilineString(
					...
					"            val inParamId = new KnowledgeID(\"A2\", scope.keys)",
					"            messageInstance.A2 = inParamId.getKnowledge(typeof(String))",
					"            val inParamId_1 = new KnowledgeID(\"A3\", scope.keys)",
		...
		public void message1argument1in1out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"A1\", scope.keys).isDefined) && !(new KnowledgeID(\"A2\", scope.keys).isBound)) {",
					"            val messageInstance = new M",
					"            val inParamId = new KnowledgeID(\"A1\", scope.keys)",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            enabledMessages += new ProtocolMessage<M>(spaceInstance, messageInstance, new KnowledgeID(\"R2\", scope.keys).getKnowledge(typeof(UUID)))",
		...
		public void message1argument2in1out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"A1\", scope.keys).isDefined) && (new KnowledgeID(\"A2\", scope.keys).isDefined) && !(new KnowledgeID(\"A3\", scope.keys).isBound)) {",
					"            val messageInstance = new M",
					"            val inParamId = new KnowledgeID(\"A1\", scope.keys)",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            val inParamId_1 = new KnowledgeID(\"A2\", scope.keys)",
		...
		public void message1argument3in1out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"A1\", scope.keys).isDefined) && (new KnowledgeID(\"A2\", scope.keys).isDefined) && (new KnowledgeID(\"A3\", scope.keys).isDefined) && !(new KnowledgeID(\"A4\", scope.keys).isBound)) {",
					"            val messageInstance = new M",
					"            val inParamId = new KnowledgeID(\"A1\", scope.keys)",
					"            messageInstance.A1 = inParamId.getKnowledge(typeof(double))",
					"            val inParamId_1 = new KnowledgeID(\"A2\", scope.keys)",
		...
		public void message1argument3in2key2out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"A1\", scope.keys).isDefined) && (new KnowledgeID(\"A2\", scope.keys).isDefined) && !(new KnowledgeID(\"A5\", scope.keys).isBound) && (new KnowledgeID(\"A3\", scope.keys).isDefined) && !(new KnowledgeID(\"A4\", scope.keys).isBound)) {",
					"            val messageInstance = new M",
					"            messageInstance.A1 = scope.keys.get(0) as double // A1",
					"            val inParamId = new KnowledgeID(\"A2\", scope.keys)",
					"            messageInstance.A2 = inParamId.getKnowledge(typeof(String))",
		...
		public void message1bargument3in2key2out() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance_1 !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"A1\", scope_1.keys).isDefined) && (new KnowledgeID(\"A2\", scope_1.keys).isDefined) && !(new KnowledgeID(\"A5\", scope_1.keys).isBound) && (new KnowledgeID(\"A3\", scope_1.keys).isDefined) && !(new KnowledgeID(\"A4\", scope_1.keys).isBound)) {",
					"            val messageInstance_1 = new M",
					"            messageInstance_1.A1 = scope_1.keys.get(0) as double // A1",
					"            val inParamId_1 = new KnowledgeID(\"A2\", scope_1.keys)",
	...
	public class PrivateParameterTest extends AbstractBsplTest {
		...
		public void message1argument3in1key() throws Exception {
			...
			var expected = multilineString(
					...
					"            messageInstance.A1 = scope.keys.get(0) as double // A1",
					"            // Ignoring private parameter: A2",
					"            val inParamId = new KnowledgeID(\"A3\", scope.keys)",
	...
	public class NilArgumentTest extends AbstractBsplTest {
		...
		public void outModifier() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if (!(new KnowledgeID(\"P1\", scope.keys).isBound)) {",
					"            val messageInstance = new M",
					"            enabledMessages += new ProtocolMessage<M>(spaceInstance, messageInstance, new KnowledgeID(\"R2\", scope.keys).getKnowledge(typeof(UUID)))",
					"          }",
					"        }",
		...
		public void inModifier() throws Exception {
			...
			var expected = multilineString(
					...
					"      if (spaceInstance !== null) {",
					"        synchronized (localStateManagerLock) {",
					"          if ((new KnowledgeID(\"P1\", scope.keys).isDefined)) {",
					"            val messageInstance = new M",
					"            val inParamId = new KnowledgeID(\"P1\", scope.keys)",
