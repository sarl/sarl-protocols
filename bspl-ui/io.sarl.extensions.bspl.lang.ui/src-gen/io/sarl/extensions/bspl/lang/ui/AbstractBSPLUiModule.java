...
import io.sarl.extensions.bspl.lang.ide.contentassist.antlr.BSPLParser;
import io.sarl.extensions.bspl.lang.ide.contentassist.antlr.PartialBSPLContentAssistParser;
import io.sarl.extensions.bspl.lang.ide.contentassist.antlr.internal.InternalBSPLLexer;
import io.sarl.extensions.bspl.lang.ui.codemining.BSPLCodeMiningProvider;
import io.sarl.extensions.bspl.lang.ui.contentassist.BSPLProposalProvider;
import io.sarl.extensions.bspl.lang.ui.editor.BSPLEditor;
import io.sarl.extensions.bspl.lang.ui.labeling.BSPLDescriptionLabelProvider;
import io.sarl.extensions.bspl.lang.ui.labeling.BSPLLabelProvider;
import io.sarl.extensions.bspl.lang.ui.outline.BSPLOutlineTreeProvider;
import io.sarl.extensions.bspl.lang.ui.quickfix.BSPLQuickfixProvider;
...
/**
 * Manual modifications go to {@link BSPLUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractBSPLUiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractBSPLUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(io.sarl.extensions.bspl.lang.parser.antlr.internal.InternalBSPLLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalBSPLLexer.class).toProvider(LexerProvider.create(InternalBSPLLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return BSPLLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(BSPLDescriptionLabelProvider.class);
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return BSPLQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return BSPLProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialBSPLContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("BSPL Compare");
	}
	...
	public void configureCodeMining(Binder binder) {
		binder.bind(ICodeMiningProvider.class)
			.to(BSPLCodeMiningProvider.class);
