...
package io.sarl.extensions.bspl.lang.ui.preferences;
...
public final class BSPLPreferences {
	...
	public static IPreferenceStore getBSPLPreferencesFor(IProject project) {
		if (project != null) {
			final var injector = LangActivator.getInstance().getInjector(LangActivator.IO_SARL_EXTENSIONS_BSPL_LANG_BSPL);
