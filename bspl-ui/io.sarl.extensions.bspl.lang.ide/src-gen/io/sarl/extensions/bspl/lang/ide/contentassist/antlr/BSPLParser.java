 ...
 */
package io.sarl.extensions.bspl.lang.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import io.sarl.extensions.bspl.lang.ide.contentassist.antlr.internal.InternalBSPLParser;
...
public class BSPLParser extends AbstractPartialContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(BSPLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BSPLGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getAlternatives(), "rule__ProtocolFirstParameter__Alternatives");
			builder.put(grammarAccess.getParameterModifierAccess().getAlternatives(), "rule__ParameterModifier__Alternatives");
			builder.put(grammarAccess.getMessageTargetModifierAccess().getAlternatives(), "rule__MessageTargetModifier__Alternatives");
			builder.put(grammarAccess.getProtocolVisibilityModifierAccess().getAlternatives(), "rule__ProtocolVisibilityModifier__Alternatives");
			...
			builder.put(grammarAccess.getProtocolSpecificationAccess().getGroup_1(), "rule__ProtocolSpecification__Group_1__0");
			...
			builder.put(grammarAccess.getProtocolAccess().getGroup_5_2(), "rule__Protocol__Group_5_2__0");
			builder.put(grammarAccess.getProtocolAccess().getGroup_6(), "rule__Protocol__Group_6__0");
			builder.put(grammarAccess.getProtocolAccess().getGroup_6_1(), "rule__Protocol__Group_6_1__0");
			builder.put(grammarAccess.getProtocolRoleAccess().getGroup(), "rule__ProtocolRole__Group__0");
			builder.put(grammarAccess.getProtocolRoleAccess().getGroup_2(), "rule__ProtocolRole__Group_2__0");
			builder.put(grammarAccess.getProtocolRoleAccess().getGroup_2_1(), "rule__ProtocolRole__Group_2_1__0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getGroup_0(), "rule__ProtocolFirstParameter__Group_0__0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getGroup_0_1(), "rule__ProtocolFirstParameter__Group_0_1__0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getGroup_0_1_4(), "rule__ProtocolFirstParameter__Group_0_1_4__0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getGroup_1(), "rule__ProtocolFirstParameter__Group_1__0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getGroup_1_4(), "rule__ProtocolFirstParameter__Group_1_4__0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getGroup_2(), "rule__ProtocolFirstParameter__Group_2__0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getGroup_2_3(), "rule__ProtocolFirstParameter__Group_2_3__0");
			builder.put(grammarAccess.getProtocolFollowingParameterAccess().getGroup(), "rule__ProtocolFollowingParameter__Group__0");
			builder.put(grammarAccess.getProtocolFollowingParameterAccess().getGroup_3(), "rule__ProtocolFollowingParameter__Group_3__0");
			builder.put(grammarAccess.getProtocolMessageAccess().getGroup(), "rule__ProtocolMessage__Group__0");
			builder.put(grammarAccess.getProtocolMessageAccess().getGroup_8(), "rule__ProtocolMessage__Group_8__0");
			builder.put(grammarAccess.getProtocolMessageAccess().getGroup_8_1(), "rule__ProtocolMessage__Group_8_1__0");
			builder.put(grammarAccess.getProtocolMessageAccess().getGroup_8_1_1(), "rule__ProtocolMessage__Group_8_1_1__0");
			builder.put(grammarAccess.getArgumentDefAccess().getGroup(), "rule__ArgumentDef__Group__0");
			...
			builder.put(grammarAccess.getProtocolSpecificationAccess().getPackageAssignment_1_1(), "rule__ProtocolSpecification__PackageAssignment_1_1");
			builder.put(grammarAccess.getProtocolSpecificationAccess().getImportSectionAssignment_2(), "rule__ProtocolSpecification__ImportSectionAssignment_2");
			builder.put(grammarAccess.getProtocolSpecificationAccess().getBsplProtocolsAssignment_3(), "rule__ProtocolSpecification__BsplProtocolsAssignment_3");
			builder.put(grammarAccess.getProtocolAccess().getModifiersAssignment_1(), "rule__Protocol__ModifiersAssignment_1");
			builder.put(grammarAccess.getProtocolAccess().getNameAssignment_3(), "rule__Protocol__NameAssignment_3");
			builder.put(grammarAccess.getProtocolAccess().getMembersAssignment_5_1(), "rule__Protocol__MembersAssignment_5_1");
			builder.put(grammarAccess.getProtocolAccess().getMembersAssignment_5_2_1(), "rule__Protocol__MembersAssignment_5_2_1");
			builder.put(grammarAccess.getProtocolAccess().getMembersAssignment_6_0(), "rule__Protocol__MembersAssignment_6_0");
			builder.put(grammarAccess.getProtocolAccess().getMembersAssignment_6_1_1(), "rule__Protocol__MembersAssignment_6_1_1");
			builder.put(grammarAccess.getProtocolAccess().getMembersAssignment_7(), "rule__Protocol__MembersAssignment_7");
			builder.put(grammarAccess.getProtocolRoleAccess().getNameAssignment_1(), "rule__ProtocolRole__NameAssignment_1");
			builder.put(grammarAccess.getProtocolRoleAccess().getMinAssignment_2_1_0(), "rule__ProtocolRole__MinAssignment_2_1_0");
			builder.put(grammarAccess.getProtocolRoleAccess().getMaxAssignment_2_2(), "rule__ProtocolRole__MaxAssignment_2_2");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getModifiersAssignment_0_1_0(), "rule__ProtocolFirstParameter__ModifiersAssignment_0_1_0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getModifiersAssignment_0_1_2(), "rule__ProtocolFirstParameter__ModifiersAssignment_0_1_2");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getNameAssignment_0_1_3(), "rule__ProtocolFirstParameter__NameAssignment_0_1_3");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getTypeAssignment_0_1_4_1(), "rule__ProtocolFirstParameter__TypeAssignment_0_1_4_1");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getModifiersAssignment_0_1_5(), "rule__ProtocolFirstParameter__ModifiersAssignment_0_1_5");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getModifiersAssignment_1_0(), "rule__ProtocolFirstParameter__ModifiersAssignment_1_0");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getModifiersAssignment_1_2(), "rule__ProtocolFirstParameter__ModifiersAssignment_1_2");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getNameAssignment_1_3(), "rule__ProtocolFirstParameter__NameAssignment_1_3");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getTypeAssignment_1_4_1(), "rule__ProtocolFirstParameter__TypeAssignment_1_4_1");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getModifiersAssignment_1_5(), "rule__ProtocolFirstParameter__ModifiersAssignment_1_5");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getModifiersAssignment_2_1(), "rule__ProtocolFirstParameter__ModifiersAssignment_2_1");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getNameAssignment_2_2(), "rule__ProtocolFirstParameter__NameAssignment_2_2");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getTypeAssignment_2_3_1(), "rule__ProtocolFirstParameter__TypeAssignment_2_3_1");
			builder.put(grammarAccess.getProtocolFirstParameterAccess().getModifiersAssignment_2_4(), "rule__ProtocolFirstParameter__ModifiersAssignment_2_4");
			builder.put(grammarAccess.getProtocolFollowingParameterAccess().getModifiersAssignment_1(), "rule__ProtocolFollowingParameter__ModifiersAssignment_1");
			builder.put(grammarAccess.getProtocolFollowingParameterAccess().getNameAssignment_2(), "rule__ProtocolFollowingParameter__NameAssignment_2");
			builder.put(grammarAccess.getProtocolFollowingParameterAccess().getTypeAssignment_3_1(), "rule__ProtocolFollowingParameter__TypeAssignment_3_1");
			builder.put(grammarAccess.getProtocolFollowingParameterAccess().getModifiersAssignment_4(), "rule__ProtocolFollowingParameter__ModifiersAssignment_4");
			builder.put(grammarAccess.getProtocolMessageAccess().getFromAssignment_1(), "rule__ProtocolMessage__FromAssignment_1");
			builder.put(grammarAccess.getProtocolMessageAccess().getModifiersAssignment_3(), "rule__ProtocolMessage__ModifiersAssignment_3");
			builder.put(grammarAccess.getProtocolMessageAccess().getToAssignment_4(), "rule__ProtocolMessage__ToAssignment_4");
			builder.put(grammarAccess.getProtocolMessageAccess().getModifiersAssignment_5(), "rule__ProtocolMessage__ModifiersAssignment_5");
			builder.put(grammarAccess.getProtocolMessageAccess().getMessageAssignment_7(), "rule__ProtocolMessage__MessageAssignment_7");
			builder.put(grammarAccess.getProtocolMessageAccess().getArgumentsAssignment_8_1_0(), "rule__ProtocolMessage__ArgumentsAssignment_8_1_0");
			builder.put(grammarAccess.getProtocolMessageAccess().getArgumentsAssignment_8_1_1_1(), "rule__ProtocolMessage__ArgumentsAssignment_8_1_1_1");
			builder.put(grammarAccess.getArgumentDefAccess().getModifiersAssignment_1(), "rule__ArgumentDef__ModifiersAssignment_1");
			builder.put(grammarAccess.getArgumentDefAccess().getNameAssignment_2(), "rule__ArgumentDef__NameAssignment_2");
			builder.put(grammarAccess.getArgumentDefAccess().getModifiersAssignment_3(), "rule__ArgumentDef__ModifiersAssignment_3");
	...
	@Override
	protected InternalBSPLParser createParser() {
		InternalBSPLParser result = new InternalBSPLParser(null);
